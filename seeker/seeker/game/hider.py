...
class Hider:
    ...
    def get_hint(self):
        ...
        """
        hint = "(-.-) Nap time."
        if self._distance[-1] == 0: #self.distance[-1] gets the last/final element of the array
            hint = "(;.;) You found me!"
        elif self._distance[-1] > self._distance[-2]: #self.distance[-2] gets the second last/final element of the array
            hint = "(^.^) Getting colder!"
